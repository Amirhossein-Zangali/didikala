...
$page_count = Comment::getCommentPageCount();
                        ...
                        <div class="col-12">
                            ...
                            <div class="profile-section dt-sl">
                                ...
                                if (User::isUserWriter()) {
                                    $comments = Comment::getWriterComments($_SESSION['user_id'], Comment::$itemPerPage, $offset);
                                }
                                if (User::isUserAdmin()) {
                                    $comments = Comment::getAllComments(Comment::$itemPerPage, $offset);
                                }
                                if ($comments->count() > 0) :?>
                                        ...
                                        <table class="table table-order">
                                            ...
                                            <?php foreach ($comments as $index => $comment) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $comment->strengths ?></td>
                                                    <td><?= $comment->weaknesses ?></td>
                                                    <td><?= Comment::convertRecommendation($comment->recommendation) ?></td>
                                                    <td>
